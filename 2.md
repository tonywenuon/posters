...
![](https://latex.codecogs.com/gif.latex?\alpha_{ij}=\frac{exp(e_{ij})}{\sum_{k=1}{exp(e_{ik})}})
![](https://latex.codecogs.com/gif.latex?e_{ij}=F(s_{i-1},h_j))
...
![](https://latex.codecogs.com/gif.latex?p(y_i|y_1,\dots,y_{i-1},x)=g(y_{i-1},s_i,c_i))
