...
#### 4.3 SQuAD v2.0
SQuAD v2.0 跟 SQuAD v1.1 的区别是在 v2.0 中，给定的段落并不一定包含问题的答案，其实这样的设定也跟实际生活中更加贴近。解决这个问题，我们可以在上面的解决方案上进行扩展。还记得 `[CLS]` 标记吧（感觉这个标记在 BERT 中是万能的，啥都能用它）。在预测答案的起始终止位置的时候，我们增加一个 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4OTE5MTA1MzUsLTMzMTk1MTUwMiw1Nj
